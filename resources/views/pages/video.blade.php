<x-layout>
    <x-slot:heading>Kumpulan Video Cerita Rakyat</x-slot:heading>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <a href="/video/timun-mas" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full transition duration-200 ease-in-out">Lihat Detail</a>
                </div>
            </div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <a href="/video/pesut-mahakam" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full transition duration-200 ease-in-out">Lihat Detail</a>
                </div>
            </div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <a href="/video/nenek-pakande" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full transition duration-200 ease-in-out">Lihat Detail</a>
                </div>
            </div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <a href="/video/malin-kundang" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full transition duration-200 ease-in-out">Lihat Detail</a>
                </div>
            </div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <a href="/video/karupet-anak-duyung" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full transition duration-200 ease-in-out">Lihat Detail</a>
                </div>
            </div>
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <a href="/video/sangkuriang" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full transition duration-200 ease-in-out">Lihat Detail</a>
                </div>
            </div>
        </div>
    </div>
