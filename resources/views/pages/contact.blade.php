        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="p-4">
                    ...
                    <a href="/ebook/TimunMas" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full transition duration-200 ease-in-out">Lihat Detail</a>
                </div>
            </div>

            {{-- Card 2 --}}
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <img src="{{ asset('assets\img\MalinKundang.png') }}" alt="MalinKundang" class="w-full h-48 object-cover">
                <div class="p-4">
                    <h2 class="text-xl font-semibold mb-2">MalinKundang</h2>
                    <p class="text-gray-600 text-sm mb-4">Cerita unik dari Kalimantan Timur.</p>
                    <a href="/ebook/MalinKundang" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-full transition duration-200 ease-in-out">Lihat Detail</a>
                </div>
            </div>
